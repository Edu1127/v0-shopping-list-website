...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://hipxwhxqpnsfdbtoaxfs.supabase.co") || '';
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhpcHh3aHhxcG5zZmRidG9heGZzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM5OTAyNTcsImV4cCI6MjA3OTU2NjI1N30.15PwdhQ7xcl6qQPR_T2GUnzqnZUHzutxU8FHf4ddSmQ") || '';
...
async function updateProfile(userId, updates) {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update({
            ...updates,
...
function AuthProvider({ children }) {
    ...
    async function checkUser() {
        try {
            const { user: currentUser } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
            setUser(currentUser);
        } catch (error) {
...
//# sourceMappingURL=_7bd94121._.js.map